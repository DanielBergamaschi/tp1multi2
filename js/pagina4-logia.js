...
function cajaTexto () {
        ...
        cuadroTextoX = random (50, 100);
        cuadroTextoY = random (50, 300);
...
function cuadradosTexto () {
    ...
    push();
        ...
        strokeWeight (1);
        fill (0, 20);
        rect (15, 20, cuadroTextoX+10, cuadroTextoY);
    pop();
    ...
    push();
        ...
        textSize (15);
        text ("El Eden esta bajo nuestros pies dijeron los rebeldes y con ese grito degollaron a los que escuchaban las voces del cielo", 20, 20, cuadroTextoX, cuadroTextoY);
    pop();
