...
function textos() {
    ...
    for (let i = 0; i < totalCopias; i++) {
        ...
        rotate(HALF_PI);
        text('-34.60556, -58.38528 -34.60556, -58.38528 -34.60556, -58.38528', 0, 0);
        pop();
    }
